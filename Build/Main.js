...
(function (Enemy_1) {
    ...
    class EnemySmash extends Enemy {
        constructor(_id, _attributes, _position, _netId) {
            ...
            this.coolDown = new Entity.Cooldown(2 * Game.frameRate);
            this.avatars = [];
    ...
    class EnemyDash extends Enemy {
        constructor(_id, _attributes, _position, _netId) {
            super(_id, _attributes, _position, _netId);
            this.isAttacking = false;
            this.coolDownDash = new Entity.Cooldown(3 * Game.frameRate);
            this.dashCount = 1;
            this.avatars = [];
            this.randomPlayer = Math.round(Math.random());
        }
...
(function (Enemy) {
    class Summonor extends Enemy.EnemyShoot {
        constructor(_id, _attributes, _position, _netId) {
            ...
            this.summonChance = 5;
            this.summonCooldown = 120;
            this.summonCurrentCooldown = 0;
            this.tag = Tag.TAG.ENEMY;
...
(function (Player_1) {
    ...
    class Player extends Entity.Entity {
        constructor(_id, _attributes, _netId) {
            super(_id, _attributes, _netId);
            this.weapon = new Weapons.Weapon(12, 1, Bullets.BULLETTYPE.STANDARD, 1, this.netId, Weapons.AIM.NORMAL);
            this.tick = 0;
            this.positions = [];
            this.hostPositions = [];
            this.time = 0;
