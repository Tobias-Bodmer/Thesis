    ...
    function update() {
        ...
        if (Game.gamestate == Game.GAMESTATES.PLAYING) {
            ...
            if (Game.connected) {
                ...
                Game.avatar2.collider.position = Game.avatar2.mtxLocal.translation.toVector2();
