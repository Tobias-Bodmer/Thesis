            ...
            colliders.forEach((element) => {
                if (this.collider.collides(element.collider) && element.attributes != undefined && this.killcount > 0) {
                    if (element.attributes.healthPoints > 0) {
                        ...
                        Game.graph.addChild(new UI.DamageUI(element.cmpTransform.mtxLocal.translation, Math.round(element.getDamageReduction(this.hitPointsScale))));
                        this.lifetime = 0;
                        this.killcount--;
                    }
                }
...
(function (Player_1) {
    ...
    class Player extends Entity.Entity {
        items = [];
        weapon = new Weapons.Weapon(12, 1, Bullets.NORMALBULLETS.STANDARD, 1);
        tick = 0;
        positions = [];
        hostPositions = [];
        time = 0;
