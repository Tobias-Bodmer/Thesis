...
(function (UI) {
    ...
    class MiniRoom extends Game.ƒ.Node {
        constructor(_coordinates, _roomType) {
            ...
            this.startRoomMat = new ƒ.Material("startRoomMat", ƒ.ShaderFlat, new ƒ.CoatRemissive(ƒ.Color.CSS("red", this.opacity)));
            this.normalRoomMat = new ƒ.Material("normalRoomMat", ƒ.ShaderFlat, new ƒ.CoatRemissive(ƒ.Color.CSS("white", this.opacity)));
            this.merchantRoomMat = new ƒ.Material("merchantRoomMat", ƒ.ShaderFlat, new ƒ.CoatRemissive(ƒ.Color.CSS("green", this.opacity)));
            this.treasureRoomMat = new ƒ.Material("treasureRoomMat", ƒ.ShaderFlat, new ƒ.CoatRemissive(ƒ.Color.CSS("yellow", this.opacity)));
            this.challengeRoomMat = new ƒ.Material("challengeRoomMat", ƒ.ShaderFlat, new ƒ.CoatRemissive(ƒ.Color.CSS("blue", this.opacity)));
            this.bossRoomMat = new ƒ.Material("bossRoomMat", ƒ.ShaderFlat, new ƒ.CoatRemissive(ƒ.Color.CSS("black", this.opacity)));
    ...
    class Wall extends ƒ.Node {
        ...
        addDoor(_pos, _scaling) {
            ...
            if (Math.abs(_pos.x) > 0) {
                ...
                if (_pos.x > 0) {
                    this.door.nextRoom = { north: false, east: true, south: false, west: false };
                    this.door.mtxLocal.translateX(-0.5);
                }
                else {
                    this.door.nextRoom = { north: false, east: false, south: false, west: true };
                    this.door.mtxLocal.translateX(0.5);
                }
            }
            else {
                ...
                if (_pos.y > 0) {
                    this.door.nextRoom = { north: true, east: false, south: false, west: false };
                    this.door.mtxLocal.translateY(-0.5);
                }
                else {
                    this.door.nextRoom = { north: false, east: false, south: true, west: false };
                    this.door.mtxLocal.translateY(0.5);
                }
            }
        }
    ...
    function switchRoom(_direction) {
        if (Game.currentRoom.finished) {
            if (_direction.north) {
                ...
                sendRoom({ coordinates: Game.currentRoom.neighbourN.coordinates, direction: exits, exits: Game.currentRoom.neighbourN.exits, roomType: Game.currentRoom.neighbourN.roomType, translation: Game.currentRoom.neighbourN.mtxLocal.translation });
                addRoomToGraph(Game.currentRoom.neighbourN, exits);
            }
            if (_direction.east) {
                let exits = { north: false, east: false, south: false, west: true };
                sendRoom({ coordinates: Game.currentRoom.neighbourE.coordinates, direction: exits, exits: Game.currentRoom.neighbourE.exits, roomType: Game.currentRoom.neighbourE.roomType, translation: Game.currentRoom.neighbourE.mtxLocal.translation });
                addRoomToGraph(Game.currentRoom.neighbourE, exits);
            }
            if (_direction.south) {
                let exits = { north: true, east: false, south: false, west: false };
                sendRoom({ coordinates: Game.currentRoom.neighbourS.coordinates, direction: exits, exits: Game.currentRoom.neighbourS.exits, roomType: Game.currentRoom.neighbourS.roomType, translation: Game.currentRoom.neighbourS.mtxLocal.translation });
                addRoomToGraph(Game.currentRoom.neighbourS, exits);
            }
            if (_direction.west) {
                let exits = { north: false, east: true, south: false, west: false };
                sendRoom({ coordinates: Game.currentRoom.neighbourW.coordinates, direction: exits, exits: Game.currentRoom.neighbourW.exits, roomType: Game.currentRoom.neighbourW.roomType, translation: Game.currentRoom.neighbourW.mtxLocal.translation });
