...
(function (UI) {
    class Minimap extends Game.ƒ.Node {
        ...
        currentRoom;
        pointer;
        constructor(_coordinates, _minimapInfo) {
            super("Minimap");
    ...
    class MiniRoom extends Game.ƒ.Node {
        ...
        constructor(_coordinates, _rooms) {
            super("MinimapRoom");
...
(function (Networking) {
            ...
            if (message.idSource != Networking.client.id) {
                if (message.command != FudgeNet.COMMAND.SERVER_HEARTBEAT && message.command != FudgeNet.COMMAND.CLIENT_HEARTBEAT) {
                    ...
                    if (message.content != undefined && message.content.text == FUNCTION.SPWANMINIMAP.toString()) {
                        let coordinates = [];
                        let rooms = [];
                        message.content.miniMapInfos.forEach(element => {
    ...
    function spawnMinimap(_coordinates) {
        if (Networking.client.id == Networking.client.idHost) {
            let miniMapInfos = [];
            ...
            Networking.client.dispatch({ route: undefined, idTarget: Networking.clients.find(elem => elem.id != Networking.client.idHost).id, content: { text: FUNCTION.SPWANMINIMAP, miniMapInfos: miniMapInfos } });
        }
    }
