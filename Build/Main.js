    ...
    class Summonor extends Enemy.EnemyShoot {
        ...
        defencePhase() {
            ...
            if (this.defencePhaseCurrentTime > 0) {
                ...
                this.buffs.find(buff => buff.id == Buff.BUFFID.IMMUNE).duration = 0;
                this.mtxLocal.translation = (new ƒ.Vector2(0, 0)).toVector3();
                this.shooting360();
            }
            // }
                            ...
                            buffList.forEach(buff => {
                                switch (buff.id) {
                                    ...
                                    case Buff.BUFFID.IMMUNE:
                                        newBuffs.push(new Buff.AttributesBuff(buff.id, buff.duration, buff.tickRate, buff.value));
                                        break;
                                }
                            });
