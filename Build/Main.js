...
(function (Player_1) {
    ...
    class Player extends Entity.Entity {
        weapon = new Weapons.Weapon(12, 1, Bullets.BULLETTYPE.STANDARD, 10, this.netId, Weapons.AIM.NORMAL);
        client;
        server;
        abilityCount = 1;
