        ...
        document.getElementById("StartGame").addEventListener("click", () => {
            ...
            async function waitOnConnection() {
                ...
                if (Networking.clients.filter(elem => elem.ready == true).length >= 2 && Networking.client.idHost != undefined) {
                    ...
                    if (Networking.client.id == Networking.client.idHost) {
                        EnemySpawner.spawnByID(Enemy.ENEMYCLASS.SUMMONORADDS, Entity.ID.REDTICK, new Game.ƒ.Vector2(3, 3), null, Game.avatar1);
...
(function (Enemy) {
    class Summonor extends Enemy.EnemyShoot {
        ...
        summon = new Ability.SpawnSummoners(this.netId, 0, 8, 300);
...
(function (Player_1) {
    ...
    class Ranged extends Player {
        dash = new Ability.Dash(this.netId, 5000, 1, 5 * 60, 2);
