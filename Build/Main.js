...
(function (Items) {
    ...
    class ItemGenerator {
        ...
        getPossibleItems() {
            let chosenRarity = this.generateRarity();
            switch (chosenRarity) {
                case RARITY.COMMON:
