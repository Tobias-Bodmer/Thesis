...
(function (Networking) {
                ...
                if (message.command != FudgeNet.COMMAND.SERVER_HEARTBEAT && message.command != FudgeNet.COMMAND.CLIENT_HEARTBEAT) {
                    ...
                    if (Game.connected) {
                        ...
                        if (message.content != undefined && message.content.text == FUNCTION.SPAWNBULLETENEMY.toString()) {
                            ...
                            if (enemy != null) {
                                if (enemy instanceof Enemy.Summonor && Networking.client.id != Networking.client.idHost) {
    ...
    function spawnBullet(_direction, _bulletNetId) {
        if (Game.connected) {
            Networking.client.dispatch({ route: FudgeNet.ROUTE.VIA_SERVER, content: { text: FUNCTION.SPAWNBULLET, direction: _direction, bulletNetId: _bulletNetId } });
        }
    }
    ...
    class Weapon {
        ...
        shoot(_position, _direciton, _bulletNetId, _sync) {
            if (this.currentAttackCount > 0) {
                ...
                let magazine = this.loadMagazine(_position, _direciton, this.bulletType, this.projectileAmount, _bulletNetId);
