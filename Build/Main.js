...
(function (Networking) {
    ...
    (function (FUNCTION) {
        ...
        FUNCTION[FUNCTION["SPAWNBULLET"] = 6] = "SPAWNBULLET";
        FUNCTION[FUNCTION["SPAWNBULLETENEMY"] = 7] = "SPAWNBULLETENEMY";
        FUNCTION[FUNCTION["BULLETTRANSFORM"] = 8] = "BULLETTRANSFORM";
        FUNCTION[FUNCTION["BULLETDIE"] = 9] = "BULLETDIE";
        FUNCTION[FUNCTION["SPAWNENEMY"] = 10] = "SPAWNENEMY";
        FUNCTION[FUNCTION["ENEMYTRANSFORM"] = 11] = "ENEMYTRANSFORM";
        FUNCTION[FUNCTION["ENEMYSTATE"] = 12] = "ENEMYSTATE";
        FUNCTION[FUNCTION["ENEMYDIE"] = 13] = "ENEMYDIE";
        FUNCTION[FUNCTION["SPAWNITEM"] = 14] = "SPAWNITEM";
        FUNCTION[FUNCTION["UPDATEATTRIBUTES"] = 15] = "UPDATEATTRIBUTES";
        FUNCTION[FUNCTION["ITEMDIE"] = 16] = "ITEMDIE";
        FUNCTION[FUNCTION["SENDROOM"] = 17] = "SENDROOM";
        FUNCTION[FUNCTION["SWITCHROOMREQUEST"] = 18] = "SWITCHROOMREQUEST";
