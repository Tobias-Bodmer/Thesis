...
namespace Networking {
    export enum FUNCTIONPLAYER {
        SPAWN,
        TRANSFORM,
        BULLET
    }
    export enum FUNCTIONENEMY {
        SPAWN,
        TRANSFORM
    }
    ...
    export function updatePosition(_position: ƒ.Vector3, _rotation: ƒ.Vector3) {
        client.dispatch({ route: FudgeNet.ROUTE.VIA_SERVER, content: { text: FUNCTIONPLAYER.TRANSFORM, value: _position, rotation: _rotation } })
    }
